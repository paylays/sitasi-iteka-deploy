...
@section('content')
    ...
    <div class="row mt-4">
        <div class="col-4">
            <a href="{{ route('data-pengajuan:bimbingan') }}" class="card bg-primary border-primary text-white-50" style="position: relative; overflow: hidden;">
                <div class="card-body" style="position: relative; z-index: 1;">
                    <h3 class="mb-4 text-white"><i class="fas fa-book me-3"></i>Bimbingan</h3>
                    <p class="card-text text-light">Cek Bimbingan Mahasiswa anda disini!</p>
                </div>
                <div class="card-bimbingan"></div>
            </a>
        </div>
        <div class="col-4">
            <a href="{{ route('data-pengajuan:seminar-proposal') }}" class="card bg-danger border-danger text-white-50" style="position: relative; overflow: hidden;">
                <div class="card-body" style="position: relative; z-index: 1;">
                    <h3 class="mb-4 text-white"><i class="fas fa-book-reader me-3"></i>Seminar Proposal</h3>
                    <p class="card-text text-light">Cek Seminar Proposal mahasiswa anda disini!</p>
                </div>
                <div class="card-sempro"></div>
            </a>
        </div>
        <div class="col-4">
            <a href="{{ route('data-pengajuan:sidang-ta') }}" class="card bg-success border-success text-white-50" style="position: relative; overflow: hidden;">
                <div class="card-body" style="position: relative; z-index: 1;">
                    <h3 class="mb-4 text-white"><i class="fas fa-user-graduate me-3"></i>Sidang TA</h3>
                    <p class="card-text text-light">Cek Sidang TA Mahasiswa anda disini!</p>
                </div>
