    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Jadwal Sempro</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Jadwal</a></li>
                        <li class="breadcrumb-item active">Jadwal Sempro</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        @forelse ($periode as $period)
                                            <tr>
                                                ...
                                                <td class="text-xs font-weight-bold mb-0 px-0"><a href="{{ route('jadwal:sempro:detail', ['periode_id' => $period->id]) }}" class="btn btn-primary btn-sm">Lihat Jadwal</a></td>
