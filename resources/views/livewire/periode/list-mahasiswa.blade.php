<div>
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">List Pendaftar Sidang TA</h4>
    
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Periode</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('periode-sempro') }}">Periode TA</a></li>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th
                                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                        Lembar Persetujuan Revisi Proposal TA</th>
                                    <th
                                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                        Form Ta.006</th>
                                    <th
                                    ...
                                    <th
                                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                        Lembar Pernyataan Kesanggupan Revisi</th>
                                    <th
                                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                        Draft Laporan TA</th>
                                    <th
                                ...
                                @forelse ($list as $period)
                                    <tr>
                                        ...
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a href="{{ route('pdf:lembar-persetujuan-revisi', ['userId' => $period->user_id]) }}" target="_blank" class="text-info">Cek File</a>
                                        </td>
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a href="{{ route('pdf:form-ta-006', ['userId' => $period->user_id]) }}" class="text-info" target="_blank">Cek File</a>
                                        </td>
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a href="{{ route('pdf:form-ta-007', ['userId' => $period->user->id ]) }}" class="text-info" target="_blank">Cek File</a>
                                        </td>
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a href="{{ route('pdf:form-ta-008', ['userId' => $period->user->id ]) }}" class="text-info" target="_blank">Cek File</a>
                                        </td>
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a href="{{ asset('storage/'.$period->lembar_revisi) }}" class="text-info" target="_blank">Cek File</a>
                                        </td>
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a href="{{ asset('storage/'.$period->draft_ta) }}" class="text-info" target="_blank">Cek File</a>
                                        </td>
                                        <td class="text-xs font-weight-bold mb-0">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Update Sidang TA</h1>
    ...
    <div class="modal fade @if($tolakModal) show @endif" @if($tolakModal) style="display: block" @endif id="tambahData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Tolak Sidang TA</h1>
                    <button type="button" class="btn-close" wire:click="closeTolakModal()"  aria-label="Close"></button>
                </div>
                <form wire:submit="tolakSidang()" method="POST">
                    <div class="modal-body">
                        <div class="form-container">
