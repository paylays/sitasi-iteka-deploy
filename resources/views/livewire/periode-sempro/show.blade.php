    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Periode Sempro</h4>
    
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Periode</a></li>
                        <li class="breadcrumb-item active">Periode Sempro</li>
                    </ol>
                </div>
                ...
                <div class="row gx-4 align-items-center">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="my-heading">Periode Sempro</h2>
                                    ...
                                    <tbody>
                                        @forelse ($periode as $period)
                                            <tr>
                                                ...
                                                <td class="text-xs font-weight-bold mb-0"><a href="{{ route('periode-sempro:list', ['id' => $period->id]) }}" class="btn btn-primary btn-sm">Lihat Mahasiswa</a></td>
    ...
    <div class="modal fade @if($addModal) show @endif" @if($addModal) style="display: block" @endif id="tambahData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('periode-sempro:store') }}" method="POST">
